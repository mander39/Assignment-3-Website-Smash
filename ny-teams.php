...
<body>
	...
	<article>
		...
		<h3>Home Stadium</h3>
		<p>Under new ownership, the current name was adopted in 1963 and the franchise moved to [Shea Stadium](https://en.wikipedia.org/wiki/Shea_Stadium) in 1964 and then to the [Meadowlands Sports Complex](https://en.wikipedia.org/wiki/Meadowlands_Sports_Complex) in 1984.</p>
	...
	<article>
		...
		<h3>Home Stadium</h3>
		<p>The Knicks compete in the [National Basketball Association](https://en.wikipedia.org/wiki/National_Basketball_Association) (NBA) as a member of the [Atlantic Division](https://en.wikipedia.org/wiki/Atlantic_Division_(NBA)) of the [Eastern Conference](https://en.wikipedia.org/wiki/Eastern_Conference_(NBA)). The team plays its home games at [Madison Square Garden](https://en.wikipedia.org/wiki/Madison_Square_Garden). They are one of two NBA teams located in New York City; the other is the [Brooklyn Nets](https://en.wikipedia.org/wiki/Brooklyn_Nets).</p>
		<h3>Championships</h3>
		<p> It was not until the late 1960s when [Red Holzman](https://en.wikipedia.org/wiki/Red_Holzman) became head coach that the Knicks began to regain their former dominance. Holzman successfully guided the Knicks to two NBA championships, in [1970](https://en.wikipedia.org/wiki/1969%E2%80%9370_NBA_season) and [1973](https://en.wikipedia.org/wiki/1972%E2%80%9373_NBA_season). The Knicks of the 1980s had mixed success that included six playoff appearances; however, they failed to participate in the NBA Finals.</p>
	</article>
</body>
</html>